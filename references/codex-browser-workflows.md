...
`mmkc-tiktok-search-skill` has three browser-control paths. Pick the least fragile path that can complete the user's TikTok research task.
...
```text
mmkc-tiktok-search-skill/projects/tiktok-research/YYYYMMDD_HHMMSS_manual_<slug>/
